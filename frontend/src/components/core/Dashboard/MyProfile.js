...
const MyProfile = () => {
  ...
  return (
    <div className='mx-auto w-11/12 max-w-[1000px] py-10 overflow-auto'>
             ...
             <div className='flex gap-y-5 md:flex-row flex-col max-w-[500px] justify-between'>
                ...
                <div className='flex flex-col gap-y-5'>
                    ...
                    <div>
                        ...
                        <p className='text-sm font-medium text-richblack-5'>{user?.additionalDetails?.contactNor ?? "Add Contact Number"}</p>
                    </div>
                    <div>
